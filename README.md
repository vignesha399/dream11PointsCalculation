...
###############################################################
INSTRUCTIONS :
1. execute this command before run the code "npm i"
2. THE BODY OF THE DATA TO ADD THE TEAM SHOULD BE BELOW FORMAT 

    {
        "TeamName": "Chennai Super Kings",
        "Players":["RD Gaikwad","YBK Jaiswal","JC Buttler","SV Samson","D Padikkal","R Ashwin","SO Hetmyer","R Parag","OC McCoy","Navdeep Saini","Karun Nair"],
        "Captain": "RD Gaikwad",
        "viceCaptain":"YBK Jaiswal"
    } 
